...
$gridConfig = [
    ...
    'columns' => [
        ...
        [
            'attribute' => 'name',
            'format' => 'html',
            'filter' => Html::activeDropDownList($searchModel, 'name',
        ...
        [
            ...
            'format' => 'html',
            'filter' => Html::activeDropDownList($searchModel, 'parentCategory',
                ArrayHelper::map(Category::find()->parent()->all(), 'id', 'name'),
                ['class'=>'form-control','prompt' => 'Выберите категорию']
            ),
        ],
        [
